...
\begin{figure}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=.9\textwidth]{figures/acp_ocp_pp_example}
        \caption{%
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=.9\textwidth]{latex/figures/acp_ocp_pp_sampling_distributions}
        \caption{%
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=.9\textwidth]{latex/figures/acp_ocp_pp_bias_mae_mse}
        \caption{%
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{latex/figures/naive_adaptive_and_optimal_designs}
    \caption{%
...
\begin{figure}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=.9\textwidth]{latex/figures/recalculation-type-II-original-m}
        \caption{%
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=.9\textwidth]{latex/figures/recalculation-type-II-earlier}
        \caption{%
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=.9\textwidth]{latex/figures/recalculation-lambda-approach-original-m}
        \caption{%
