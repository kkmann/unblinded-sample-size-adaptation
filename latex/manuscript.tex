...
\begin{figure}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=.9\textwidth]{figures/acp_ocp_pp_sampling_distributions}
        \caption{%
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=.9\textwidth]{figures/acp_ocp_pp_bias_mae_mse}
        \caption{%
...
\begin{figure}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=.9\textwidth]{figures/recalculation-type-II-original-m}
        \caption{%
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=.9\textwidth]{figures/recalculation-type-II-earlier}
        \caption{%
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=.9\textwidth]{figures/recalculation-lambda-approach-original-m}
        \caption{%
